...
public slots:
    ...
    void DiagramItemSizeChanged(CubesDiagram::DiagramItem* item);
    ...
    void PropertiesTextChanged(CubesUnit::PropertiesId propertiesId, QString text, uint32_t fontSize, bool showBorder,
